...
seneca.act({role: 'math', cmd: 'sum', left: 1.5, right: 2.5}, (err,res)=>{console.log(res)})
seneca.act({role: 'math', cmd: 'sum', left: 1.5, right: 2.5, integer: true},  (err,res)=>{console.log(res)})
